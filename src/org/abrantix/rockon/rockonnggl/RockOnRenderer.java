...
public abstract class RockOnRenderer {
	...
	//
	protected float mPositionX = 0.f;
	protected float mTargetPositionX = 0.f;
	protected float mPositionY = 0.f;
	protected float mTargetPositionY = -1.f;
	protected float mRotationInitialPositionY = 0.f;

	protected boolean mIsChangingCat = false;
}
