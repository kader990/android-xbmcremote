...
public class HttpClient {
	 ...
	 */
	public HttpClient(String host, int timeout, IErrorHandler errorHandler) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public HttpClient(String host, int port, int timeout, IErrorHandler errorHandler) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public HttpClient(String host, String username, String password, int timeout, IErrorHandler errorHandler) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public HttpClient(String host, int port, String username, String password, int timeout, IErrorHandler errorHandler) throws BackendException {		
		mConnection= new Connection(host, port, username, password, timeout);
		info = new InfoClient(host, port, username, password, timeout);
		music = new MusicClient(host, port, username, password, timeout);
		video = new VideoClient(mConnection);
		control = new ControlClient(host, port, username, password, timeout);
	}
