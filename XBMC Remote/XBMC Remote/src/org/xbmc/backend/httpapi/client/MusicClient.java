...
import org.xbmc.backend.httpapi.IErrorHandler;
 ...
 * @author Team XBMC
 */
public class MusicClient extends Connection{
	
	public MusicClient(String host, int port, String username, String password,
...
//	}
	 ...
	 */
	public boolean addToPlaylist(Album album) throws BackendException {
		return getBoolean("AddToPlayListFromDB", LIBRARY_TYPE + ";" + getSongsCondition(album));
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean addToPlaylist(Artist artist) throws BackendException {
		return getBoolean("AddToPlayListFromDB", LIBRARY_TYPE + ";" + getSongsCondition(artist));
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean addToPlaylist(Genre genre) throws BackendException {
		return getBoolean("AddToPlayListFromDB", LIBRARY_TYPE + ";" + getSongsCondition(genre));
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean addToPlaylist(Artist artist, Genre genre) throws BackendException {
		return getBoolean("AddToPlayListFromDB", LIBRARY_TYPE + ";" + getSongsCondition(artist, genre));
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean addToPlaylist(Song song) throws BackendException {
		return getBoolean("AddToPlayList", song.path + ";" + PLAYLIST_ID);
	}
	 ...
	 * @throws BackendException 
	 */
	public int getPlaylistSize() throws BackendException {
		return getInt("GetPlaylistLength", PLAYLIST_ID);
	}
	 ...
	 * @throws BackendException 
	 */
	public int getPlaylistPosition() throws BackendException {
		return getInt("GetPlaylistSong");
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean setPlaylistPosition(int position) throws BackendException {
		return getBoolean("SetPlaylistSong", String.valueOf(position));
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean removeFromPlaylist(int position) throws BackendException {
		return getBoolean("RemoveFromPlaylist", PLAYLIST_ID + ";" + position);
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean removeFromPlaylist(String path) throws BackendException {
		return getBoolean("RemoveFromPlaylist", PLAYLIST_ID + ";" + path);
	}
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<String> getPlaylist() throws BackendException {
		return getArray("GetPlaylistContents", PLAYLIST_ID);
		
		
		/*
		final ArrayList<String> nodes = getArray("GetDirectory", "playlistmusic://");
	 ...
	 * @throws BackendException 
	 */
	public boolean clearPlaylist() throws BackendException {
		return getBoolean("ClearPlayList", PLAYLIST_ID);
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean play(Song song) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean play(Album album) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean play(Genre genre) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean play(Artist artist) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean play(Artist artist, Genre genre) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	private boolean play(StringBuilder sqlCondition) throws BackendException {
		clearPlaylist();
		getBoolean("AddToPlayListFromDB", LIBRARY_TYPE + ";" + sqlCondition.toString());
		setCurrentPlaylist();
		return playNext();
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean playPrev() throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean playlistSetSong(int pos) throws BackendException {
		return getBoolean("SetPlaylistSong", String.valueOf(pos));
	}
	 ...
	 * @throws BackendException 
	 */
	public boolean setCurrentPlaylist() throws BackendException {
		return getBoolean("SetCurrentPlaylist", PLAYLIST_ID);
	}
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Album> getAlbums(ArrayList<Integer> artistIDs) throws BackendException {
		...
		sb.append(")");
		return parseAlbums(query("QueryMusicDatabase", sb.toString()));
	}
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Album> getAlbums() throws BackendException {
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT idAlbum, strAlbum, strArtist, iYear, strThumb");
		sb.append(" FROM albumview WHERE albumview.strAlbum <> ''");
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Album> getAlbums(Artist artist) throws BackendException {
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT idAlbum, strAlbum, strArtist, iYear, strThumb");
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Album> getAlbums(Genre genre) throws BackendException {
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT idAlbum, strAlbum, strArtist, iYear, strThumb");
		sb.append("  FROM albumview");
		sb.append("  WHERE albumview.strAlbum <> ''");
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Artist> getArtists(boolean albumArtistsOnly) throws BackendException {
		StringBuilder sb = new StringBuilder();
		if (albumArtistsOnly) {
		...
		return parseArtists(query("QueryMusicDatabase", sb.toString()));
	}
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Artist> getArtists(Genre genre, boolean albumArtistsOnly) throws BackendException {
		StringBuilder sb = new StringBuilder();
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Genre> getGenres() throws BackendException {
		return parseGenres(query("QueryMusicDatabase", "SELECT idGenre, strGenre FROM genre ORDER BY upper(strGenre), strGenre"));
	}
	 ...
	 * @throws BackendException 
	 */
	public Album updateAlbumInfo(Album album) throws BackendException {
		StringBuilder sb = new StringBuilder();
		...
		return parseAlbumInfo(album, query("QueryMusicDatabase", sb.toString()));
	}
	 ...
	 * @throws BackendException 
	 */
	private ArrayList<Song> getSongs(StringBuilder sqlCondition) throws BackendException {
		StringBuilder sb = new StringBuilder();
		...
		return parseSongs(query("QueryMusicDatabase", sb.toString()));
	}
	...
	private HashMap<Integer, Song> getSongsAsHashMap(StringBuilder sqlCondition) {
		...
		sb.append(sqlCondition);
		sb.append(" ORDER BY iTrack, strFileName");
		return parseSongsAsHashMap(query("QueryMusicDatabase", sb.toString()));
	}*/
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Song> getSongs(Album album) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Song> getSongs(Artist artist) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Song> getSongs(Genre genre) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Song> getSongs(Artist artist, Genre genre) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public String getAlbumThumb(ICoverArt art) throws BackendException {
		final String data = query("FileDownload", Album.getThumbUri(art));
		if (data.length() > 0) {
			return data;
		} else {
			Log.i("MusicClient", "*** Downloaded cover has size null, retrying with fallback:");
			return query("FileDownload", Album.getFallbackThumbUri(art));
		}
	}
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<Integer> getCompilationArtistIDs() throws BackendException {
		StringBuilder sb = new StringBuilder();
		...
		return parseIntArray(query("QueryMusicDatabase", sb.toString()));
	...
	public static ICurrentlyPlaying getCurrentlyPlaying(final HashMap<String, String> map) {
