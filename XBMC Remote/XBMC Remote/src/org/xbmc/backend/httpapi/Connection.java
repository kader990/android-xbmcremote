...
package org.xbmc.backend.httpapi;
...
import org.xbmc.backend.exceptions.NoSettingsException;
import org.xbmc.backend.exceptions.WrongDataFormatException;
...
public class Connection {
	 ...
	 */
	public Connection(String host, int port, String username, String password, int timeout) throws BackendException {
...
//			setResponseFormat();
	 ...
	 * @throws Exception 
	 */
	public synchronized String query(String method, String parameters) throws BackendException {
		try {
			if (!settingsOK) {
...
//			final long connectionTimer = System.currentTimeMillis();
	 ...
	 * @throws BackendException 
	 */
	public String getString(String method, String parameters) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public String getString(String method) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public int getInt(String method, String parameters) throws BackendException {
		try {
	 ...
	 * @throws BackendException 
	 */
	public int getInt(String method) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean getBoolean(String method, String parameters) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean getBoolean(String method) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public ArrayList<String> getArray(String method, String parameters) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public HashMap<String, String> getPairs(String method, String parameters) throws BackendException {
		final String[] rows = query(method, parameters).split(LINE_SEP);
	 ...
	 * @throws BackendException 
	 */
	public HashMap<String, String> getPairs(String method) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	public boolean assertBoolean(String method, String parameters) throws BackendException {
	 ...
	 * @throws BackendException 
	 */
	private void setResponseFormat() throws BackendException {
