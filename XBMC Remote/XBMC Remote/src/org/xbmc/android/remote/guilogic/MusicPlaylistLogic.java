	...
	public void onCreate(final Activity activity, final ListView list) {
		if (!isCreated()) {
			...
			HttpApiThread.music().getPlaylistPosition(new HttpApiHandler<Integer>(activity) {
				...
				@Override
				public void doFinish(Integer value) {
				...
				@Override
				public void doFinish(ArrayList<String> value) {
			...
			mList.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					HttpApiThread.music().setPlaylistSong(new HttpApiHandlerAdapter<Boolean>((Activity)view.getContext()), holder.getHolderItem().position);
				}
			});
	...
	public void onContextItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			case ITEM_CONTEXT_PLAY:
				HttpApiThread.music().setPlaylistSong(new HttpApiHandlerAdapter<Boolean>(mActivity), holder.getHolderItem().position);
				break;
			case ITEM_CONTEXT_REMOVE:
				HttpApiThread.music().removeFromPlaylist(new HttpApiHandlerAdapter<Boolean>(mActivity), holder.getHolderItem().path);
				break;
			default:
				return;
		}
